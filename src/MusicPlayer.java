...
public class MusicPlayer extends PlaybackListener {
    ...
    public void loadSong(Song song){
        ...
        if(currentSong != null){
            ...
            musicPlayerGUI.updateCurrentTimeLabel(0);
                ...
                while (!isPaused && !songFinished && !pressedNext && !pressedPrev) {
                    try {
                        ...
                        if (elapsedTime >= 1000) {  // Update every second
                            currentTimeInMilli += elapsedTime;
                            ...
                            SwingUtilities.invokeLater(new Runnable() {
                                ...
                                public void run() {
                                    ...
                                    musicPlayerGUI.updateCurrentTimeLabel(currentTimeInMilli);
                                }
                            });
                        }

                        Thread.sleep(50);  // Sleep for a shorter period
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
                }
